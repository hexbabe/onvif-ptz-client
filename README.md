# [`onvif-ptz-client` module](https://app.viam.com/module/seanorg/onvif-ptz-client)

This module implements the [`"rdk:component:generic"` API](https://docs.viam.com/components/generic/) for controlling ONVIF-compliant PTZ (Pan-Tilt-Zoom) cameras. The generic component supports core PTZ operations through the DoCommand method.
...
```json
{
  "model": "seanorg:onvif-ptz-client:client",
  "attributes": {
    "address": "192.168.1.100:80",
    "username": "admin",
    "password": "yourpassword",
...
1. **Disclaimer**: This module was made in order to fully integrate with one specific camera. I tried to generalize it to all PTZ cameras, but your mileage may vary.
